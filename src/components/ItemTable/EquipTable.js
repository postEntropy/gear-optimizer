...
const EquipTable = React.memo((props) => {
    ...
    const renderCurrent = () => (
        <Grid item xs={12}>
            <Paper elevation={2} sx={{ p: 2, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
    ...
    const renderSaved = () => (
        <>
            <Grid item xs={12}>
                <Paper elevation={2} sx={{ p: 2, mb: 1, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}>
